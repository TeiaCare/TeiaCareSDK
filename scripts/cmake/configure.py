...
def main():
    ...
    run([
        ...
        '-D', f'TEIACORE_SDK_ENABLE_UNIT_TESTS={str(args.unit_tests or args.coverage)}',
        '-D', f'TEIACORE_SDK_ENABLE_UNIT_TESTS_COVERAGE={str(args.coverage)}',
        '-D', f'TEIACORE_SDK_ENABLE_BENCHMARKS={str(args.benchmarks)}',
        '-D', f'TEIACORE_SDK_ENABLE_EXAMPLES={str(args.examples)}',
        '-D', f'TEIACORE_SDK_ENABLE_WARNINGS_ERROR={str(args.warnings)}',
        '-D', f'TEIACORE_SDK_ENABLE_SANITIZER_ADDRESS={str(args.address_sanitizer)}',
        '-D', f'TEIACORE_SDK_ENABLE_SANITIZER_THREAD={str(args.thread_sanitizer)}',
        '-D', f'TEIACORE_SDK_ENABLE_CLANG_FORMAT={str(args.clang_format)}',
        '-D', f'TEIACORE_SDK_ENABLE_CLANG_TIDY={str(args.clang_tidy)}',
        '-D', f'TEIACORE_SDK_ENABLE_CPPCHECK={str(args.cppcheck)}',
        '-D', f'TEIACORE_SDK_ENABLE_CPPLINT={str(args.cpplint)}',
        '-D', f'TEIACORE_SDK_ENABLE_DOCS={str(args.docs)}',
