...
#include "test_argparse_optional_argument.hpp"

#include "test_argparse_argument_base.hpp"

namespace tc::sdk::tests
{
TEST_F(test_argparse_optional_argument, default_properties)
{
    {
        int value = 1;
...
TEST_F(test_argparse_optional_argument, parse_error)
{
    using Type = int;
    Type value;
...
TEST_F(test_argparse_optional_argument, parse_int)
{
    using Type = int;
    Type value;
    tc::sdk::optional_argument<Type> arg("long_name", "s", value);
...
TEST_F(test_argparse_optional_argument, parse_float)
{
    using Type = float;
    Type value;
    tc::sdk::optional_argument<Type> arg("long_name", "s", value);
...
TEST_F(test_argparse_optional_argument, parse_double)
{
    using Type = double;
    Type value;
    tc::sdk::optional_argument<Type> arg("long_name", "s", value);
...
TEST_F(test_argparse_optional_argument, parse_string)
{
...
TEST_F(test_argparse_optional_argument, parse_vector_string)
{
...
TEST_F(test_argparse_optional_argument, parse_from_env_variable_found)
{
    int value = 1;
    int default_value = 2;
    tc::sdk::optional_argument<int> arg("flag_a", "a", value, default_value, "Argument Description", true, ENV_VAR);
...
TEST_F(test_argparse_optional_argument, validator_failure)
{
    ...
    EXPECT_THROW(arg.parse("short_string"), std::runtime_error);
    EXPECT_FALSE(arg.is_parsed());
    EXPECT_EQ(value, "");
}
...
TEST_F(test_argparse_optional_argument, validator_success)
{
    ...
    EXPECT_NO_THROW(arg.parse("very_very_very_very_long_string"));
    EXPECT_TRUE(arg.is_parsed());
    EXPECT_EQ(value, "very_very_very_very_long_string");
}
